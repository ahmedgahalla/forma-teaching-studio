...
export const SUPPORT_PRESETS = {
  ...
  firm: { label: 'Double-stiffness virtual support', translationNPerMm: 200, rotationNmmPerRad: 2000 },
} as const;
export const MATERIAL_PRESETS = {
  'stainless-steel': { label: 'Stainless steel — ideal elastic', youngNPerMm2: 200000, poisson: .3, maxStrain: .002 },
  'beta-titanium': { label: 'Beta titanium — ideal elastic', youngNPerMm2: 69000, poisson: .3, maxStrain: .003 },
} as const;
export const MECHANICS_SOURCES = [
  { title: 'Reduced tooth support and beam-element methodology (not its remodeling law)', url: 'https://link.springer.com/article/10.1186/s40510-018-0255-8' },
  { title: 'Measured alloy differences; a teaching preset is not a manufacturer specification', url: 'https://pubmed.ncbi.nlm.nih.gov/17045145/' },
  { title: '69 GPa beta-titanium assumption used in an orthodontic beam analysis', url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC7510485/' },
  { title: 'Wire dimensions and slot clearance affect torque expression', url: 'https://pubmed.ncbi.nlm.nih.gov/32924097/' },
  { title: 'Expander force depends on appliance and supporting-structure compliance', url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC3880096/' },
] as const;
export const MECHANICS_LIMITS = {
  teeth: 32, wires: 4, tads: 8, elastics: 12, expanders: 1, stages: 20,
  sectionMinMm: .20, sectionMaxMm: .8, expansionMm: 2, torqueDeg: 20,
  forceN: 20, stiffnessNPerMm: 1000, pointMm: 200, localPointMm: 30,
  maxRotationDeg: 5, maxRootDisplacementFraction: .05, maxIterations: 40,
} as const;
