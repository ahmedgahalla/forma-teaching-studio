...
`/api/interpret-teaching` validates supported classroom and initial-mechanics requests. Local geometry tools retain their own bounds and constraints; an AI response cannot bypass them or invent missing appliance values.
